...
Fork of: https://github.com/gianluccacolangelo/evolving-art
...
🖥 Screenshots
### Menu Screen Game-style interface with population management 
...
### Create Population Initialize new evolution experiments with custom parameters 
![Create Population Screen](plots/create_population.png) 
### Evolution Screen Multi-select grid with live previews, inspector panel, and mutation controls 
...
Populations stored under:

populations/<name>/history/gen_###.json

🔗 Attribution

Evolutionary engine base
→ gianluccacolangelo / evolving-art
gin-based genome extensions

🧪 Procedural seeds librar
